  ...
  <div style="justify-content: center; display: flex;">
    <el-container style="display: flex;">
      <el-table :data="userList" :border="true" :default-sort="{ prop: 'date', order: 'descending' }"
        ...
        <el-table-column width="120" prop="manage_available" label="管理用户">
          <template #default="scope">
            <el-switch v-model="scope.row.manage_available" />
          </template>
        </el-table-column>
        <el-table-column width="120" prop="live_available" label="创建直播">
          <template #default="scope">
            <el-switch v-model="scope.row.live_available" />
          </template>
        </el-table-column>
        <el-table-column width="120" prop="message_available" label="查看短信">
          <template #default="scope">
